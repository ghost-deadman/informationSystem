...
import com.example.informationSystem.service.*;
...
public class ProjectInspectionController {
     ...
     */
    @PostMapping("/Build/ProjectInspection/Id/Update")
     ...
     * @return 返回信息封装工具类
     */
    @PostMapping("/Build/ProjectInspection/Id/Delete")
     ...
     * @return 返回信息封装工具类
     */
    @GetMapping("/Build/ProjectInspection/User/Status/Page/List")
     ...
     * @return 返回信息封装工具类
     */
    @GetMapping({"/Build/ProjectInspection/Unit/PrincipalStatus/Page/List","/Build/ProjectInspection/Unit/AdminCreateStatusSuccess/Page/List"})
     ...
     * @return 返回信息封装工具类
     */
    @GetMapping("/Build/ProjectInspection/Unit/AdminStatusFailure/Page/List")
     ...
     * @return 返回信息封装工具类
     */
    @GetMapping("/Build/ProjectInspection/Unit/PrincipalStatusSuccess/Page/List")
     ...
     * @return 返回信息封装工具类
     */
    @GetMapping("/Build/ProjectInspection/Unit/PrincipalStatusFailure/Page/List")
     ...
     * @return 返回信息封装工具类
     */
    @GetMapping({"/Centralized/ProjectInspection/AdminStatus/Page/List",})
     ...
     * @return 返回信息封装工具类
     */
    @GetMapping({"/Centralized/ProjectInspection/AdminStatusSuccess/Page/List",})
     ...
     * @return 返回信息封装工具类
     */
    @GetMapping({"/Centralized/ProjectInspection/AdminStatusFailure/Page/List",})
     ...
     * @return 返回信息封装工具类
     */
    @GetMapping("/Build/ProjectInspection/Id/ProjectSubmit/Update")
     ...
     * @return 返回信息封装工具类
     */
    @GetMapping("/Build/ProjectInspection/Id/AdminApprove/Update")
     ...
     * @return 返回信息封装工具类
     */
    @GetMapping("/Build/ProjectInspection/Id/AdminApproveFailure/Update")
     ...
     * @return 返回信息封装工具类
     */
    @GetMapping("/Build/ProjectInspection/Id/PrincipalApprove/Update")
     ...
     * @return 返回信息封装工具类
     */
    @GetMapping("/Build/ProjectInspection/Id/PrincipalApproveFailure/Update")
     ...
     * @return 返回信息封装工具类
     */
    @GetMapping("/Centralized/ProjectInspection/Id/AdminApprove/Update")
     ...
     * @return 返回信息封装工具类
     */
    @GetMapping("/Centralized/ProjectInspection/Id/AdminApproveFailure/Update")
